...
paperweight {
    ...
    val sojuCombat = forks.register("soju-combat") {
        upstream.patchDir("paperServer") {
            upstreamPath = "paper-server"
            excludes = setOf("src/minecraft", "patches", "build.gradle.kts")
            patchesDir = rootDirectory.dir("soju-combat-server/paper-patches")
            outputDir = rootDirectory.dir("paper-server")
        }
    }
    activeFork = sojuCombat
...
dependencies {
    implementation(project(":soju-combat-api"))
